//API
export const RESIZE_APP_CONTENT = 'resize_app_content';
...
// DATA_SOURCE_SEARCH_ENGINE
export const ADD_ID_DATA_SOURCE = 'add_id_data_source';
export const CHOOSE_NAME_TABLE = 'choose_name_table';
export const LIST_COLUMNS = 'list_columns';
export const CHOOSE_COLUMNS = 'choose_columns';
export const RENAME_INDEX = 'rename_index';
export const NEW_COLUMNS = 'add_new_columns';
export const CLEAR_ADD_INDEX = 'clear_add_index';
export const CONFIG_INDEX = 'config_index';
export const SOURCE_ENGINE_ACTIVE = 'source_engine_active';

// Manage data versions
export const ADD_ID_ORGANIZATION = 'add_id_organization';
export const ADD_SOURCE_ID = 'add_source_id';
export const ADD_ID_CONNECTION = 'add_id_connection';
export const ADD_NAME_TABLE = 'add_name_table';
export const ADD_KEY_RECORD = 'add_key_record';
export const ADD_DESTINATION_ID = 'add_destination_id';
export const RESET_DATA_VERSION = 'reset_manage_data_versions';

// Automatic data enrichment
export const ADD_ID_ORGANIZATION_AUTO_DATA = 'add_id_organization_auto_data';
export const ADD_DATA_TYPES = 'add_data_types';
export const ADD_SOURCE_ID_AUTO_DATA = 'add_source_id_auto_data';
export const ADD_ID_CONNECTION_AUTO_DATA = 'add_id_connection_auto_data';
export const CLEAR_AUTO_DATA = 'clear_auto_data';
