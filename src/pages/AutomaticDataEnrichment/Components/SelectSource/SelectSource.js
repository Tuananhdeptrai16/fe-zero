...
function SelectSource({ next, prev, dataType }) {
  ...
  const handleContinue = () => {
    dispatch({ type: ADD_SOURCE_ID_AUTO_DATA, payload: selectedRowKeys[0] });
    dispatch({ type: ADD_ID_CONNECTION_AUTO_DATA, payload: '' });
    next();
  };
  return (
    <>
