...
AggregateExamination.propTypes = {};

function AggregateExamination() {
  return (
    <DataAggregationMechanism
      category={SCHOOLS_WAREHOUSE_TYPE.EXAMINATION}
      pageName={ROUTER_NAME.DATA_AGGREGATION_MECHANISM_EXAMINATION}
    />
  );
}

export default AggregateExamination;
