...
const DynamicStudentProgress = () => {
  return (
    <div>
      <DataAggregationMechanism
        type={TYPE_DATA_MARK_SCHOOL_WAREHOUSE.DTM}
        category={TYPE_DATA_MARK_SCHOOL_WAREHOUSE.DYNAMIC_STUDENT_PROGRESS}
        pageName={ROUTER_NAME.DYNAMIC_STUDENT_PROGRESS}
        titleAppMeta='dynamic_student_progress'
      />
    </div>
  );
};

export default DynamicStudentProgress;
