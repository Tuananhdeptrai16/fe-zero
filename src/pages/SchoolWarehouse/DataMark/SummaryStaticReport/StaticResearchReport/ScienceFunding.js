...
const ScienceFunding = () => {
  return (
    <div>
      <DataAggregationMechanism
        type={TYPE_DATA_MARK_SCHOOL_WAREHOUSE.DTM}
        category={TYPE_DATA_MARK_SCHOOL_WAREHOUSE.SCIENCE_FUNDING}
        pageName={ROUTER_NAME.SCIENCE_FUNDING}
        titleAppMeta='science_funding'
      />
    </div>
  );
};

export default ScienceFunding;
