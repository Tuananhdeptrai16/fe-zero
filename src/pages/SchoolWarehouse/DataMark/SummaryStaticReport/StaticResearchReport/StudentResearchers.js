  ...
  return (
    <div>
      <DataAggregationMechanism
        ...
        category={TYPE_DATA_MARK_SCHOOL_WAREHOUSE.STUDENT_RESEARCHER}
        pageName={ROUTER_NAME.STUDENT_RESEARCHER}
        titleAppMeta='student_researcher'
      />
    </div>
  );
};

export default StudentResearchers;
