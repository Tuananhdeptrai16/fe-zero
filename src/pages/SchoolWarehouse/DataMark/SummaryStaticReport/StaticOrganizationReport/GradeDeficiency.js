...
const GradeDeficiency = () => {
  return (
    <div>
      <DataAggregationMechanism
        type={TYPE_DATA_MARK_SCHOOL_WAREHOUSE.DTM}
        category={TYPE_DATA_MARK_SCHOOL_WAREHOUSE.GRADE_DEFICIENCY}
        pageName={ROUTER_NAME.GRADE_DEFICIENCY}
        titleAppMeta='grade_deficiency'
      />
    </div>
  );
};

export default GradeDeficiency;
