  ...
  return (
    <div>
      <DataAggregationMechanism
        ...
        category={TYPE_DATA_MARK_SCHOOL_WAREHOUSE.INTERNSHIP_ACTIVITIES}
        pageName={ROUTER_NAME.INTERNSHIP_ACTIVITIES}
        titleAppMeta='internship_activities'
      />
    </div>
  );
};

export default InternshipActivities;
