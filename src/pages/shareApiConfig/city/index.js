...
const ShareApiCityPage = () => {
  const { messages } = useIntl();
  return (
    <div>
      <AppPageMetadata title={messages['share_api.city']} />
      <TableShareConfig
        initTable={initFilterByPlatform(KEY_PLATFORM.CITY)}
        platform={KEY_PLATFORM.CITY}
        routerName={ROUTER_NAME.SHARE_API_CONFIG_CITY}
...
export default ShareApiCityPage;
