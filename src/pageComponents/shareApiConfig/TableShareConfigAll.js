...
export const TableShareConfigAll = ({
  initTable,
  ...
  const actionContent = {
    [TABLE_ACTION.ACTIVATE]: {
      title: 'confirm.activateApiShareConfigTitleAll',
      success: 'confirm.activateApiShareConfigSuccessAll',
      children: (
        <ConfirmInfo
          message='confirm.activateApiShareConfigSureAll'
          name={rowData?.name}
        />
      ),
      action: () =>
    ...
    [TABLE_ACTION.DEACTIVATE]: {
      title: 'confirm.deactivateApiShareConfigTitleAll',
      success: 'confirm.deactivateApiShareConfigSuccessAll',
      children: (
        <ConfirmInfo
          message='confirm.deactivateApiShareConfigSureAll'
          name={rowData?.name}
        />
      ),
      action: () =>
    ...
    [TABLE_ACTION.DELETE]: {
      title: 'confirm.deleteApiShareConfigTitleAll',
      success: 'confirm.deleteApiShareConfigSuccessAll',
      children: (
        <ConfirmInfo
          message='confirm.deleteApiShareConfigSureAll'
          name={rowData?.name}
        />
      ),
    ...
    [TABLE_ACTION.DELETE_MULTI]: {
      title: 'confirm.massDeleteApiShareConfigTitleAll',
      success: 'confirm.deleteApiShareConfigSuccessAll',
      messageValue: {
      ...
      children: (
        <ConfirmInfo
          message='confirm.massDeleteApiShareConfigSureAll'
