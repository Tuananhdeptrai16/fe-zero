...
export const TableShareConfig = ({
  ...
  const actionContent = {
    [TABLE_ACTION.ACTIVATE]: {
      title: 'confirm.activateApiShareConfigTitle',
      success: 'confirm.activateApiShareConfigSuccess',
      children: (
        <ConfirmInfo
          message='confirm.activateApiShareConfigSure'
          name={rowData?.name}
        />
      ),
      action: () =>
    ...
    [TABLE_ACTION.DEACTIVATE]: {
      title: 'confirm.deactivateApiShareConfigTitle',
      success: 'confirm.deactivateApiShareConfigSuccess',
      children: (
        <ConfirmInfo
          message='confirm.deactivateApiShareConfigSure'
          name={rowData?.name}
        />
      ),
      action: () =>
    ...
    [TABLE_ACTION.DELETE]: {
      title: 'confirm.deleteApiShareConfigTitle',
      success: 'confirm.deleteApiShareConfigSuccess',
      children: (
        <ConfirmInfo
          message='confirm.deleteApiShareConfigSure'
          name={rowData?.name}
        />
      ),
    ...
    [TABLE_ACTION.DELETE_MULTI]: {
      title: 'confirm.massDeleteApiShareConfigTitle',
      success: 'confirm.deleteApiShareConfigSuccess',
      messageValue: {
      ...
      children: (
        <ConfirmInfo
          message='confirm.massDeleteApiShareConfigSure'
