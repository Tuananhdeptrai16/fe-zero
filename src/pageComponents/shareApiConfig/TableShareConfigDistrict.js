...
export const TableShareConfigDistrict = ({
  initTable,
  ...
  const actionContent = {
    [TABLE_ACTION.ACTIVATE]: {
      title: 'confirm.activateApiShareConfigTitleDistrict',
      success: 'confirm.activateApiShareConfigSuccessDistrict',
      children: (
        <ConfirmInfo
          message='confirm.activateApiShareConfigSureDistrict'
          name={rowData?.name}
        />
      ),
      action: () =>
    ...
    [TABLE_ACTION.DEACTIVATE]: {
      title: 'confirm.deactivateApiShareConfigTitleDistrict',
      success: 'confirm.deactivateApiShareConfigSuccessDistrict',
      children: (
        <ConfirmInfo
          message='confirm.deactivateApiShareConfigSureDistrict'
          name={rowData?.name}
        />
      ),
      action: () =>
    ...
    [TABLE_ACTION.DELETE]: {
      title: 'confirm.deleteApiShareConfigTitleDistrict',
      success: 'confirm.deleteApiShareConfigSuccessDistrict',
      children: (
        <ConfirmInfo
          message='confirm.deleteApiShareConfigSurDistricte'
          name={rowData?.name}
        />
      ),
    ...
    [TABLE_ACTION.DELETE_MULTI]: {
      title: 'confirm.massDeleteApiShareConfigTitleDistrict',
      success: 'confirm.deleteApiShareConfigSuccessDistrict',
      messageValue: {
      ...
      children: (
        <ConfirmInfo
          message='confirm.massDeleteApiShareConfigSureDistrict'
