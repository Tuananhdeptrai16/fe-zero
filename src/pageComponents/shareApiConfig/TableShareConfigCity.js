...
export const TableShareConfigCity = ({
  initTable,
  ...
  const actionContent = {
    [TABLE_ACTION.ACTIVATE]: {
      title: 'confirm.activateApiShareConfigTitleCity',
      success: 'confirm.activateApiShareConfigSuccessCity',
      children: (
        <ConfirmInfo
          message='confirm.activateApiShareConfigSureCity'
          name={rowData?.name}
        />
      ),
      action: () =>
    ...
    [TABLE_ACTION.DEACTIVATE]: {
      title: 'confirm.deactivateApiShareConfigTitleCity',
      success: 'confirm.deactivateApiShareConfigSuccessCity',
      children: (
        <ConfirmInfo
          message='confirm.deactivateApiShareConfigSureCity'
          name={rowData?.name}
        />
      ),
      action: () =>
    ...
    [TABLE_ACTION.DELETE]: {
      title: 'confirm.deleteApiShareConfigTitleCity',
      success: 'confirm.deleteApiShareConfigSuccessCity',
      children: (
        <ConfirmInfo
          message='confirm.deleteApiShareConfigSureCity'
          name={rowData?.name}
        />
      ),
    ...
    [TABLE_ACTION.DELETE_MULTI]: {
      title: 'confirm.massDeleteApiShareConfigTitleCity',
      success: 'confirm.deleteApiShareConfigSuccessCity',
      messageValue: {
      ...
      children: (
        <ConfirmInfo
          message='confirm.massDeleteApiShareConfigSureCity'
