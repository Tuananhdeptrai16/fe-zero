...
export const TableShareConfigLGSP = ({
  initTable,
  ...
  const actionContent = {
    [TABLE_ACTION.ACTIVATE]: {
      title: 'confirm.activateApiShareConfigTitleLGSP',
      success: 'confirm.activateApiShareConfigSuccessLGSP',
      children: (
        <ConfirmInfo
          message='confirm.activateApiShareConfigSureLGSP'
          name={rowData?.name}
        />
      ),
      action: () =>
    ...
    [TABLE_ACTION.DEACTIVATE]: {
      title: 'confirm.deactivateApiShareConfigTitleLGSP',
      success: 'confirm.deactivateApiShareConfigSuccessLGSP',
      children: (
        <ConfirmInfo
          message='confirm.deactivateApiShareConfigSureLGSP'
          name={rowData?.name}
        />
      ),
      action: () =>
    ...
    [TABLE_ACTION.DELETE]: {
      title: 'confirm.deleteApiShareConfigTitleLGSP',
      success: 'confirm.deleteApiShareConfigSuccessLGSP',
      children: (
        <ConfirmInfo
          message='confirm.deleteApiShareConfigSureLGSP'
          name={rowData?.name}
        />
      ),
    ...
    [TABLE_ACTION.DELETE_MULTI]: {
      title: 'confirm.massDeleteApiShareConfigTitleLGSP',
      success: 'confirm.deleteApiShareConfigSuccessLGSP',
      messageValue: {
      ...
      children: (
        <ConfirmInfo
          message='confirm.massDeleteApiShareConfigSureLGSP'
