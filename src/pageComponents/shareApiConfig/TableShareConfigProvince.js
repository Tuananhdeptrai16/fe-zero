...
export const TableShareConfigProvince = ({
  initTable,
  ...
  const actionContent = {
    [TABLE_ACTION.ACTIVATE]: {
      title: 'confirm.activateApiShareConfigTitleProvince',
      success: 'confirm.activateApiShareConfigSuccessProvince',
      children: (
        <ConfirmInfo
          message='confirm.activateApiShareConfigSureProvince'
          name={rowData?.name}
        />
      ),
      action: () =>
    ...
    [TABLE_ACTION.DEACTIVATE]: {
      title: 'confirm.deactivateApiShareConfigTitleProvince',
      success: 'confirm.deactivateApiShareConfigSuccessProvince',
      children: (
        <ConfirmInfo
          message='confirm.deactivateApiShareConfigSureProvince'
          name={rowData?.name}
        />
      ),
      action: () =>
    ...
    [TABLE_ACTION.DELETE]: {
      title: 'confirm.deleteApiShareConfigTitleProvince',
      success: 'confirm.deleteApiShareConfigSuccessProvince',
      children: (
        <ConfirmInfo
          message='confirm.deleteApiShareConfigSureProvince'
          name={rowData?.name}
        />
      ),
    ...
    [TABLE_ACTION.DELETE_MULTI]: {
      title: 'confirm.massDeleteApiShareConfigTitleProvince',
      success: 'confirm.deleteApiShareConfigSuccessProvince',
      messageValue: {
      ...
      children: (
        <ConfirmInfo
          message='confirm.massDeleteApiShareConfigSureProvince'
