...
export const TableShareConfigPortal = ({
  initTable,
  ...
  const actionContent = {
    [TABLE_ACTION.ACTIVATE]: {
      title: 'confirm.activateApiShareConfigTitlePortal',
      success: 'confirm.activateApiShareConfigSuccessPortal',
      children: (
        <ConfirmInfo
          message='confirm.activateApiShareConfigSurePortal'
          name={rowData?.name}
        />
      ),
      action: () =>
    ...
    [TABLE_ACTION.DEACTIVATE]: {
      title: 'confirm.deactivateApiShareConfigTitlePortal',
      success: 'confirm.deactivateApiShareConfigSuccessPortal',
      children: (
        <ConfirmInfo
          message='confirm.deactivateApiShareConfigSurePortal'
          name={rowData?.name}
        />
      ),
      action: () =>
    ...
    [TABLE_ACTION.DELETE]: {
      title: 'confirm.deleteApiShareConfigTitlePortal',
      success: 'confirm.deleteApiShareConfigSuccessPortal',
      children: (
        <ConfirmInfo
          message='confirm.deleteApiShareConfigSurePortal'
          name={rowData?.name}
        />
      ),
    ...
    [TABLE_ACTION.DELETE_MULTI]: {
      title: 'confirm.massDeleteApiShareConfigTitlePortal',
      success: 'confirm.deleteApiShareConfigSuccessPortal',
      messageValue: {
      ...
      children: (
        <ConfirmInfo
          message='confirm.massDeleteApiShareConfigSurePortal'
